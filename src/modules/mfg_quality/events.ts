...
export const eventsConfig = createModuleEvents({
  ...
  events: [
    { id: 'mfg_quality.inspection.out_of_spec',    label: 'Inspección fuera de especificación',           entity: 'inspection',    category: 'alert',     clientBroadcast: true },
    { id: 'mfg_quality.inspection.out_of_control', label: 'Proceso fuera de control estadístico (SPC)',   entity: 'inspection',    category: 'alert',     clientBroadcast: true },
    ...
    { id: 'mfg_quality.lot.rejected',              label: 'Lote rechazado por control de calidad',        entity: 'lot',           category: 'alert',     clientBroadcast: true },
  ],
} as const)
