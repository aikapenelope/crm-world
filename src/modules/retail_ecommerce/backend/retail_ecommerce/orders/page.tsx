...
export default function PedidosEcommercePage() {
  ...
  React.useEffect(() => {
    setLoading(true)
    apiCall('/api/retail-ecommerce/orders?pageSize=50', { method: 'GET' })
    ...
    <Page>
      <PageBody>
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-semibold">Pedidos E-commerce</h1>
          <Button type="button" variant="outline" size="sm" onClick={() => router.push('/backend/retail_ecommerce')}>
            ← Volver
          </Button>
        </div>
        <DataTable
