  ...
  const groups: CrudFormGroup[] = [
    {
      ...
      fields: [
        { id: 'name', title: 'Nombre del curso', type: 'text', required: true,
          placeholder: 'Ej: Inglés B1, Cocina Italiana Avanzada' },
        { id: 'description', title: 'Descripción', type: 'textarea',
          placeholder: 'Describe el contenido y objetivos del curso...' },
        { id: 'category', title: 'Categoría', type: 'select', required: true,
          options: COURSE_CATEGORIES.map(c => ({ value: c, label: c })) },
        { id: 'level', title: 'Nivel', type: 'select', required: true,
          options: COURSE_LEVELS.map(l => ({ value: l, label: l })) },
        { id: 'prerequisites', title: 'Prerequisitos', type: 'text',
    ...
    },
    {
      ...
      title: 'Logística',
      fields: [
        { id: 'duration_hours', title: 'Duración total (horas)', type: 'number',
          required: true, placeholder: '40' },
        { id: 'modality', title: 'Modalidad', type: 'select', required: true,
          options: [
            { value: 'in_person', label: 'Presencial' },
            { value: 'online', label: 'Online' },
            { value: 'hybrid', label: 'Híbrida' },
          ] },
        { id: 'max_students', title: 'Capacidad máxima por grupo', type: 'number',
          placeholder: '20' },
      ],
    },
    {
      ...
      title: 'Precio',
      fields: [
        { id: 'price_usd', title: 'Precio (USD)', type: 'number', required: true,
          placeholder: '150.00' },
        { id: 'is_active', title: 'Activo en catálogo', type: 'checkbox',
          defaultValue: true },
      ],
    },
  ]
