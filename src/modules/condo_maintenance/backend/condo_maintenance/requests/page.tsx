...
export default function SolicitudesdeMantenimientoPage() {
  ...
  React.useEffect(() => {
    setLoading(true)
    apiCall('/api/condo-maintenance/requests?pageSize=50', { method: 'GET' })
    ...
    <Page>
      <PageBody>
        <div className="flex items-center justify-between mb-4">
          ...
          <Button type="button" variant="outline" size="sm" onClick={() => router.push('/backend/condo_maintenance')}>
            ← Volver
          </Button>
        </div>
        <DataTable
