  ...
  const groups: CrudFormGroup[] = [
    {
      ...
      fields: [
        ...
        { id: 'unit_number', label: 'Número de unidad', type: 'text', required: true, placeholder: 'Apto 3-B' },
        {
          id: 'unit_type', label: 'Tipo', type: 'select', defaultValue: 'apartment',
          options: [
        ...
        { id: 'floor', label: 'Piso', type: 'text', placeholder: '3' },
        { id: 'area_m2', label: 'Área (m²)', type: 'text', placeholder: '85.50' },
        { id: 'aliquot_percent', label: 'Alícuota (%)', type: 'text', required: true, defaultValue: '0.00000' },
        { id: 'bedrooms', label: 'Habitaciones', type: 'number' },
        { id: 'bathrooms', label: 'Baños', type: 'number' },
        { id: 'parking_spots', label: 'Puestos de estacionamiento', type: 'number', defaultValue: '0' },
        { id: 'owner_name', label: 'Nombre del propietario', type: 'text' },
        { id: 'owner_id_card', label: 'Cédula / RIF del propietario', type: 'text' },
        { id: 'owner_phone', label: 'Teléfono del propietario', type: 'text' },
        { id: 'owner_email', label: 'Email del propietario', type: 'text' },
      ],
    },
  ]
