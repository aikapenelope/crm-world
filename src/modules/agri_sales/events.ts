...
export const eventsConfig = createModuleEvents({
  ...
  events: [
    ...
    { id: 'agri_sales.dispatch.temp_incident', label: 'Incidente de temperatura en transporte', entity: 'dispatch', category: 'custom', clientBroadcast: true },
    { id: 'agri_sales.invoice.paid',      label: 'Factura pagada',                  entity: 'invoice',  category: 'lifecycle', clientBroadcast: true },
    { id: 'agri_sales.invoice.overdue',   label: 'Factura vencida',                 entity: 'invoice',  category: 'custom',     clientBroadcast: true },
  ],
} as const)
