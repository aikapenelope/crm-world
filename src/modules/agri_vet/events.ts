...
export const eventsConfig = createModuleEvents({
  ...
  events: [
    ...
    { id: 'agri_vet.vaccination.missed',         label: 'Vacunación no aplicada (vencida)',  entity: 'vaccination',  category: 'custom',     clientBroadcast: true },
    ...
    { id: 'agri_vet.withdrawal_period.active',   label: 'Período de retiro activo en lote',  entity: 'medication',   category: 'custom',     clientBroadcast: true },
    ...
    { id: 'agri_vet.mortality.alert_triggered',  label: 'Alerta de mortalidad anormal',      entity: 'mortality',    category: 'custom',     clientBroadcast: true },
  ],
} as const)
