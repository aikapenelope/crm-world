...
export default function PortalMaintenancePage() {
  ...
  const dashboardUrl = unitId ? `/condominio/dashboard?unit_id=${unitId}` : '/condominio/dashboard'
  const createUrl = unitId
    ? `/condominio/maintenance/create?unit_id=${unitId}${buildingId ? `&building_id=${buildingId}` : ''}`
    : '/condominio/maintenance/create'
