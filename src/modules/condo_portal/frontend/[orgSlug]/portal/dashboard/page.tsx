...
export default function CondoPortalDashboard({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 md:grid-cols-4">
        <Button type="button" variant="outline" className="h-auto flex-col gap-2 p-4" onClick={() => router.push(`/${params.orgSlug}/portal/receipts`)}>
          <FileText className="size-5" />
          <span className="text-xs">Recibos</span>
        </Button>
        <Button type="button" variant="outline" className="h-auto flex-col gap-2 p-4" onClick={() => router.push(`/${params.orgSlug}/portal/maintenance`)}>
          <Wrench className="size-5" />
          <span className="text-xs">Mantenimiento</span>
        </Button>
        <Button type="button" variant="outline" className="h-auto flex-col gap-2 p-4" onClick={() => router.push(`/${params.orgSlug}/portal/circulars`)}>
          <Mail className="size-5" />
          <span className="text-xs">Circulares</span>
        </Button>
        <Button type="button" variant="outline" className="h-auto flex-col gap-2 p-4" onClick={() => router.push(`/${params.orgSlug}/portal/votes`)}>
