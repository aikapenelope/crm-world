...
export default function PortalReceiptsPage({ params }: Props) {
    ...
    <div className="mx-auto max-w-2xl p-6">
      ...
      <div className="mb-6 flex items-center gap-3">
        <Button
          ...
          variant="ghost"
          size="sm"
          onClick={() => router.push(unitId ? `/${params.orgSlug}/portal/dashboard?unit_id=${unitId}` : `/${params.orgSlug}/portal/dashboard`)}
        >
