    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <a href="/portal/payments" className="block rounded-lg border bg-white p-6 hover:shadow-md transition-shadow">
          ...
          <a href="/portal/grades" className="block rounded-lg border bg-white p-6 hover:shadow-md transition-shadow">
          ...
          <a href="/portal/attendance" className="block rounded-lg border bg-white p-6 hover:shadow-md transition-shadow">
          ...
          <a href="/portal/documents" className="block rounded-lg border bg-white p-6 hover:shadow-md transition-shadow">
