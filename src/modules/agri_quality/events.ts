...
export const eventsConfig = createModuleEvents({
  ...
  events: [
    { id: 'agri_quality.ccp.deviation_detected',   label: 'Desviación de PCC detectada — lote bloqueado', entity: 'ccp',            category: 'custom',     clientBroadcast: true },
    ...
    { id: 'agri_quality.bpm.fail_detected',        label: 'Checklist BPM con hallazgos críticos',        entity: 'bpm_checklist',  category: 'custom',     clientBroadcast: true },
