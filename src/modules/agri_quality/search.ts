  ...
  entities: [
    {
      ...
      buildSource: async (ctx: SearchBuildContext): Promise<SearchIndexSource | null> => {
        ...
        return {
          ...
          presenter: { title: norm(r.nc_number as string) ?? 'No-conformidad', subtitle: norm(r.description as string)?.slice(0, 80) ?? undefined, icon: 'file-warning', badge: statusLabel },
