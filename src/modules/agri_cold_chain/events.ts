...
export const eventsConfig = createModuleEvents({
  ...
  events: [
    ...
    { id: 'agri_cold_chain.temperature.excursion', label: 'Excursión de temperatura detectada', entity: 'temperature', category: 'custom',     clientBroadcast: true },
    ...
    { id: 'agri_cold_chain.lot.nonconformity',     label: 'No-conformidad de temperatura en lote', entity: 'storage_lot', category: 'custom', clientBroadcast: true },
  ],
} as const)
